...
# Install ODBC Driver 18 for SQL Server - Not needed in the current context but kept for reference
# RUN apt-get install -y curl gnupg apt-transport-https ca-certificates unixodbc-dev && \
